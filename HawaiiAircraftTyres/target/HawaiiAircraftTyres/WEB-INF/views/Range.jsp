...
<body>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img class="first-slide" src="resources/images/Range.jpg"
	...
	<div class="box">
		...
		<h1 style="color: White; margin-left: 40px;">Search Different
			Range of Tyres</h1>
	</div>
	<div class="container" id="style">
		</br> </br> Hawaii Aircraft Tyres is focused on providing constructors and
		operators alike with a range of high quality products backed by an
		unrivaled level of customer service - throughout the world.</br>
		...
		description of the various technologies of tyres please visit the <a
			href="technical">technical support section</a><br /></br> Click the
		appropriate link below to start searching.</br>
		</br> <a href="<c:url value="/prodlist"/>">Search different range of tyres</a></br>
		</br> </br>
